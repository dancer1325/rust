...
* == set of abstractions
  ...
  * portable
* uses
  * by [Crates library](https://crates.io)
* if you want to use it -> `use std::env`
* provides
  * [core types](../../core)  
    * _Examples:_
      * [`Vec<T>`]
      * [`Option<T>`]
  * [operations | language primitives](../../core/src/primitive_docs.md)
  * [standard macros](macros.md)
  * [I/O](io/mod.md)
  * [multithreading]
  * [other][other]
...
1. primitives
   ...
   * ['s methods / implemented by the standard library](../../core/src/primitive_docs.md)
