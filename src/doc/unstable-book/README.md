...
* hosted | https://doc.rust-lang.org/nightly/unstable-book/

## documentation
* [here](src/the-unstable-book.md)

## how to generate?
TODO: To generate them, run `./x doc unstable-book`, which will generate HTML files in `build/host/doc/unstable-book` using `src/tools/rustbook`.
